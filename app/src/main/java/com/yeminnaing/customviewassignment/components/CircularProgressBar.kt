package com.yeminnaing.customviewassignment.components
...
class CircularProgressBar @JvmOverloads constructor(
    ...
    private var trackColor =
        contextCircular.let { ContextCompat.getColor(it, R.color.colorSecondary) } ?: 0
    private var indicatorColor =
        contextCircular.let { ContextCompat.getColor(it, R.color.progressCircularBarColor) } ?: 0
    ...
    private fun setUpAttributes(attrs: AttributeSet?) {
        context.withStyledAttributes(attrs, R.styleable.CustomProgressBar) {
            ...
            indicatorColor =
                getColor(R.styleable.CustomProgressBar_customIndicatorColor, indicatorColor)
